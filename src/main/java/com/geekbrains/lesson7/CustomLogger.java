...
logger.info("Перед кликом на элеиент с текстом: " + webElement.getText() );
        Allure.step("Перед кликом на элеиент с текстом: " + webElement.getText());
    }
    ...
    public void onException(Throwable throwable, WebDriver webDriver) {
        Allure.attachment("Скриншот ошибки: ",
